...
```{r}
data.raw <- read.csv("~/Github/symcel/data/20240426_glucose_heat.csv")
design <- read.csv("~/Github/symcel/data/20240427_glucose_design_heat.csv")
```
...
png(filename ="~/Github/symcel/figures/Heat_20240427.png", 
...
legend("topleft", legend = c("blanks", "0.01", "0.1", "0.5", "1", 
        "2", "3.8", "5", "10"), col = c("grey", "cyan", "blue", 
        "green", "yellow", "orange", "red", "purple", "black"), lty = 1, 
...
img <- readPNG("~/Github/symcel/figures/Heat_20240427.png")
grid.raster(img)
```