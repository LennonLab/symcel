...
```{r}
data <- read.csv("~/Github/symcel/data/20240430_glucose_OD.csv")
design <- read.csv("~/Github/symcel/data/20240430_glucose_design_OD.csv")
```
...
png(filename ="~/Github/symcel/figures/Growth_20240427.png", 
...
axis(side = 2, lwd.ticks = 2, las = 1, cex.axis = 1.25, 
     labels = c("0.0", "0.2", "0.4", "0.6", "0.8"), at = c(0, 0.2, 0.4, 0.6, 0.8))

axis(side = 4, labels = F, lwd.ticks = 2, at = c(0, 0.2, 0.4, 0.6, 0.8))
...
img <- readPNG("~/Github/symcel/figures/Growth_20240427.png")
grid.raster(img)
```